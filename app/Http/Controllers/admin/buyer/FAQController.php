...
class FAQController extends Controller
{
    ...
    {
        return view('admin.buyer.faq.index');
    }

    
    public function create()
    {
        return view('admin.buyer.faq.create');
    }
    ...
    public function store(Request $request)
    {
       ...
       return redirect()->route('buyerfaq.index');
   }
   ...
   {
    $row = BuyerFAQ::find($id);
    return view('admin.buyer.faq.edit',compact('row'));
}


public function update(Request $request, $id)
{
    $data = BuyerFAQ::find($id);
    $data->questions= $request->questions;
    $data->answers= $request->answers;
    $data->save();
...
public function getData(Request $request){
    ...
    ->addColumn('action', function ($datatables) {
        return '<a href="'.route('buyerfaq.edit',$datatables->id).'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>&nbsp&nbsp

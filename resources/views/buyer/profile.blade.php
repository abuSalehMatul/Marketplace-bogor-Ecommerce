        ...
        <div class="row">
            <div class="col-md-12 profile-header">
                ...
                <div class="profile-info col-md-9">
                    <h1 class="profile-title">{{ $buyer->first_name }}<small>Welcome Back as Seller</small></h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                   <div class="well-box">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="state" value="{{ old('state',$row->state) }}" class="form-control" placeholder="State">
                    ...
                    <div class="form-group">
                        <label>Buy In: <span>*</span> </label>
                        <label class="radio-inline">
                            <input type="radio" name="buy_in" id="Radios1" value="1" {{ ($row->buy_in==1)?"checked":'' }} required="" >
                            Africa
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="buy_in" id="Radios2" value="2" {{ ($row->buy_in==2)?"checked":'' }} required="">
                            Global
                        </label>

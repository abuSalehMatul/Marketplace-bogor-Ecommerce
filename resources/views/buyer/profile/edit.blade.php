      ...
      <div class="col-md-9">
        <div class="row well-box">
          ...
          <div class="col-xs-12 section-space20">
            {{ Form::open(array('route' => array('buyerprofile.update', $row->id),'class' =>'form-horizontal','method' =>'PATCH','files' => true)) }}
              <div class="row">
               <div class="form-group">
                 <div class="col-sm-8">
                  <label for="">Company Logo</label>
                  <input type="file" name="logo" class="form-control" accept="image/*" onchange="loadFile(event, 'logo')">
                  <div class="text-danger">{{ $errors->first('logo') }}</div>
                </div>
                <div class="col-sm-4 ">
                 <img width="100"  id="logo" src="{{ asset($row->logo) }}" class="" alt="">
               </div>
             </div>
           </div>
           <div class="row">
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <textarea name="company_description" class="summernote">{{ $row->profile_description }}</textarea>
              </div>

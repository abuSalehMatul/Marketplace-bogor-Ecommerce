        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-wizard form-header-classic form-body-classic">
              ...
              <form role="form" class="section-space40" action="{{ url('seller-store') }}" method="post">
                @csrf
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        {!! Form::select('instant_type',[''=>'-Select Your Instant ID-','1'=>'WhatsApp','2'=>'Skype','3'=>'WeChat'], old('instant_type'),  ['class'=>'form-control ', 'required'=>'']) !!}
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" name="username" value="{{ old('username') }}" class="required form-control" placeholder="Username">
                ...
                <fieldset>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        {!! Form::select('company_status',[''=>'-Status of Company-','1'=>'Manufacturer','2'=>'Exporter'], old('company_status'),  ['class'=>'form-control required', 'required'=>'']) !!}
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="form-group">
                          <label class="col-sm-4 control-label">Sell In</label>
                          <div class="col-sm-8">

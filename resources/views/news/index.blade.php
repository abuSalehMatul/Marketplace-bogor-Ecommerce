                        ...
                        <div class="col-md-12 post-holder">
                            <div class="well-box">
                                ...
                                <div class="post-image">
                                    <a href="{{ asset("business-news-detail/$row->slug/$row->unique_code") }}"><img src="{{ asset($row->featured_image) }}" class="img-responsive" alt=""></a>
                                </div>
                                <h1 class="post-title"><a href="{{ asset("business-news-detail/$row->slug/$row->unique_code") }}">{{ $row->title }}</a></h1>
                                ...
                                <a href="{{ asset("business-news-detail/$row->slug/$row->unique_code") }}" class="btn btn-default">Read More</a> </div>
                        </div>
                        <!-- /.blog holder -->
                    </div>
                @endforeach

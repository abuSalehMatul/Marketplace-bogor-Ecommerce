                            ...
                            <table class="table table-striped city">
                                ...
                                <tbody >
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="city_name[]" value="" placeholder="Enter here..." class="form-control" required="">
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
...
<script>
    ...
    $(document).ready(function(){
      ...
      $('#add_row').on('click',function(){
        ...
        col += '<td><input type="text" name="city_name[]" value="" placeholder="Enter here..." class="form-control" required=""></td>';

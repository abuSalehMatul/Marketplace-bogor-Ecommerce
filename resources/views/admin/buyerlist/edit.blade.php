  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card-box">
            {{ Form::open(array('route' => array('buyerlist.update', $row->id),'class' =>'form-horizontal','method' =>'PATCH','files'=>true)) }}
            <div class="row">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-sm-6">
                  ...
                  {!! Form::select('company_status',[''=>'Status of Company','1'=>'Agent','2'=>'End User','3'=>'Reseller'], old('company_status',$row->company_status),  ['class'=>'form-control','required'=>'']) !!}

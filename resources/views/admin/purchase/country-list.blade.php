...
@section('title','Country Directory Purchased Plans')
@push('headerscript')
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="page-title-box">
            <h4 class="page-title">Country Directory Purchased Plans</h4>
          </div>
        </div>
      </div>
      <!-- end row -->
...
<script type="text/javascript">
  $(function() {
    $('#datatables').DataTable({
      ...
      serverSide: true,
      stateSave: true,
      ajax: '{{ url('admin/countrypurchase-getdata') }}',
      columns: [
      { data: 'rownum', name: 'rownum', searchable: false},
      { data: 'invoice_no', name: 'invoice_no' },
      { data: 'email_id', name: 'email_id' },
      { data: 'title', name: 'country_listings.title' },

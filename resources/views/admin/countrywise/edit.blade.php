  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="card-box">
            {{ Form::open(array('route' => array('countrywise.update', $row->id),'class' =>'form-horizontal','method' =>'PATCH','files'=>true)) }}
             ...
             <table class="table table-striped city">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url("admin/countrywise/deletefeature/$rows->id") }}" class="btn btn-danger  btn-sm" onclick="return confirm('Are you sure want to delete it?')"><i class="fa fa-times"></i> Remove</a>
                  </td>
                </tr>
                @endforeach
              </tbody>

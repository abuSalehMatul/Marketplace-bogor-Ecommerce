    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Add News Category</h4>
                        <div class="clearfix"><a href="{{ route('news-category.index') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-backward"></i> Back</a></div>
                    </div>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card-box">
                        <form action="{{ route('news-category.store') }}" method="post" class="form-horizontal" id="newrow">
                            @csrf

      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="page-title-box">
            <h4 class="page-title">Sector Wise Listing</h4>
            <div class="clearfix"><a href="{{ route('sectorwise.create') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-plus"></i> Add New</a></div>
          </div>
        </div>
      </div>
      <!-- end row -->
...
<script type="text/javascript">
  $(function() {
    $('#datatables').DataTable({
      ...
      serverSide: true,
      stateSave: true,
      ajax: '{{ url('admin/sectorwise/getData') }}',
      columns: [

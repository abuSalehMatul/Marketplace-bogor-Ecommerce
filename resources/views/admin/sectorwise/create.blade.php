  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="page-title-box">
            <h4 class="page-title">Add Sector Listing</h4>
            <div class="clearfix"><a href="{{ route('sectorwise.index') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-backward"></i> Back</a></div>
          </div>
        </div>
      </div>
      <!-- end row -->
      <div class="row">
        <div class="col-xs-12">
          <div class="card-box">
            <form action="{{ route('sectorwise.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="form-group">
                  <div class="col-sm-6">
                    <label for="">Name</label>
                    {!! Form::select('sector_name',[''=>'-Select Sector-']+ CommonClass::SectorList(), old('sector_name'), ['class'=>'form-control','required']) !!}

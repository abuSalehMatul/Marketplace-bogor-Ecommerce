    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card-box">
                        {{ Form::open(array('route' => array('category.update', $row->id),'class' =>'form-horizontal','method' =>'PATCH','files'=>true)) }}
                        <div class="row">
                            <div class="col-sm-6">
                              <div class="row">
                               <div class="form-group">
                                   <div class="col-sm-12">
                                       ...
                                       <input type="text" name="category_name" class="form-control" required="" value="{{ old('category_name',$row->category_name) }}">
                    ...
                    <div class="col-sm-6">
                        <img src="{{ asset($row->thumb_img) }}" alt="" id="logos" >
                    </div>
                </div>
            </form>
        </div>

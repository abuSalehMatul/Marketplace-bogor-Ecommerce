      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="page-title-box">
            ...
            <div class="clearfix"><a href="{{ route('buyerfaq.create') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New</a></div>
          </div>
        </div>
      </div>
      <!-- end row -->
...
<script type="text/javascript">
  $(function() {
    $('#datatables').DataTable({
      ...
      serverSide: true,
      stateSave: true,
      ajax: '{{ url('admin/buyerfaq/getData') }}',
      columns: [

	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="card-box">
						<form action="{{ route('sellerhelp.update',$row->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
							@method('PUT')
							@csrf
							...
							<div class="row form-group">                
								...
								<div class="col-sm-12">
									...
									<textarea name="short_description" id="" class="form-control" cols="30" rows="2" placeholder="Short Description ..">{{ old('full_description',$row->short_description) }}</textarea>

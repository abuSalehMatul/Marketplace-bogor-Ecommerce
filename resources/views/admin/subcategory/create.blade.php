    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card-box">
                        <form action="{{ route('subcategory.store') }}" method="post" class="form-horizontal" id="newrow">
                            @csrf
                            <table class="table table-striped subcategory">
                                ...
                                <tbody >
                                    <tr>
                                        <td>
                                            {!! Form::select('category_name[]',[''=>'-Select Category-']+ CommonClass::CategoryList(), old('category_name'), ['class'=>'form-control','required']) !!}
                                        </td>
                                        <td>
                                            <input type="text" name="sub_cat_name[]" value="" placeholder="Enter here..." class="form-control" required="">
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
...
<script>
    ...
    $(document).ready(function(){
      ...
      $('#add_row').on('click',function(){
        var newrow=$("<tr>");
        var col="";
        col += '<td>{!! Form::select('category_name[]',[''=>'-Select Category-']+ CommonClass::CategoryList(), old('category_name'), ['class'=>'form-control','required']) !!}</td>';
        col += '<td><input type="text" name="sub_cat_name[]" value="{{ old('category_name') }}" placeholder="Enter here..." class="form-control" required=""></td>';

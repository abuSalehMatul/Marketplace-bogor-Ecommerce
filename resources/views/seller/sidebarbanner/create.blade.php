@extends('layout.app')
@section('title','Create Side Banner')
@push('headerscript')
        ...
        <div class="row well-box">
          <div class="col-xs-12 ">
            <div class="page-title-box">
              <h4 class="page-title pull-left">Sidbar Banner Banner</h4>
          ...
          <div class="col-xs-12 section-space20">
            <form action="{{ route('sidebarbanner.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
              @csrf
              <div class="row">

@extends('layout.app')
@section('title','Manage Bottom Banner')
@push('headerscript')
                ...
                <div class="row well-box">
                    <div class="col-xs-12 ">
                        <div class="page-title-box">
                            <h4 class="page-title pull-left">Bottom Banner</h4>
                            <div class="clearfix"><a href="{{ route('bottombanner.create') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-plus"></i> Add New</a></div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('bottombanner.edit',$row->id) }}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>
...
<script>
  ...
  function(isConfirm){
   if (isConfirm){
    $.ajax({
     url: '{{ url('seller/bottombanner') }}/'+id,
     type: 'delete',
     dataType: "JSON",
     data: {
      "id": id,

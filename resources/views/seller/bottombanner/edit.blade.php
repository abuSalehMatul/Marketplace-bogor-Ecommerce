@extends('layout.app')
@section('title','Edit Bottom Banner')
@push('headerscript')
        ...
        <div class="row well-box">
          <div class="col-xs-12 ">
            <div class="page-title-box">
              ...
              <div class="clearfix"><a href="{{ route('bottombanner.index') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-backward"></i> Back</a></div>
            </div>
          </div>
          <div class="col-xs-12 section-space20">
            {{ Form::open(array('route' => array('bottombanner.update', $row->id),'class' =>'form-horizontal','method' =>'PATCH','files' => true)) }}
            <div class="row">

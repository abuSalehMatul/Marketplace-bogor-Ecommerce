                ...
                <div class="row well-box">
                    <div class="col-xs-12 ">
                        <div class="page-title-box">
                            ...
                            <div class="clearfix"><a href="{{ route('topbanner.create') }}" class="pull-right btn btn-info btn-sm"><i class="fa fa-plus"></i> Add New</a></div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('topbanner.edit',$row->id) }}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>

@extends('layout.app')
@section('title','Seller Help Center')
@push('headerscript')
            ...
            <div class="col-md-3 side-nav" id="leftCol">
                <div class="hide-side">
                    <ul class="listnone nav" id="sidebar">
                        <li class="active"><a href="{{ url('help-for-seller') }}">Help</a></li>
                        <li><a href="{{ url('faq-for-seller') }}">FAQ</a></li>
                        <li><a href="{{ url('sallersafety') }}">Safety</a>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4 content-right">
                    <div class="well-white text-center faq-block pinside60">
                        ...
                        <h2><a href="{{ url('sellersinglepage') }}" class="title">{{$r->title}}</a></h2>
